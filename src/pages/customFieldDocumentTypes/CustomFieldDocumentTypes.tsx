...
interface ICustomFieldDocumentTypesProps {
  title: string;
}
...
const CustomFieldDocumentTypes: React.FC<ICustomFieldDocumentTypesProps> = ({
  title,
}) => {
  ...
  return (
    <>
      <TitleContainer>
        <h1>Tipos de documentos dos campos customizados</h1>
      </TitleContainer>
      <PageCard>
        <FilterButtonGroup>
        ...
        >
          ...
          >
            ...
            <TableBody>
              {CustomFieldDocumentTypes.length > 0 &&
                CustomFieldDocumentTypes.map((CustomFieldDocumentType) => {
                  return (
                    ...
                    >
                      <CustomMenuItem
                        id={
                          CustomFieldDocumentType.id
                            ? String(CustomFieldDocumentType.id)
                            : ""
                        }
                        disableButton
                      />
                      ...
                      <TableCell
                        size="small"
                        width={200}
                        title={CustomFieldDocumentType.description}
                      >
          ...
          {CustomFieldDocumentTypes.length === 0 && (
            <CustomNoContentTableBody>
              <p>Nenhum tipo de documento dos campos customizados encontrado</p>
            </CustomNoContentTableBody>
          )}
        </TableContainer>
...
export default CustomFieldDocumentTypes;
