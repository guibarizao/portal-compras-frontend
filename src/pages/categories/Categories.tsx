...
const Categories: React.FC<ICategoriesProps> = ({ title }) => {
  window.document.title = title;

  const { listAllCategories } = useCategoryService();
  ...
  const handleToCategory = useCallback(
    (id: string | null) => {
      !!id ? navigate(`/category/${id}`) : navigate("/category");
    },
    [navigate]
  );
                  ...
                  return (
                    ...
                    >
                      <CustomMenuItem
                        ...
                        handleToEdit={handleToCategory}
                        disableButton={true}
                      />

                      <TableCell size="small" title={category.code} width={100}>
                        {category.code}
                      </TableCell>
                      <TableCell
                        size="small"
