...
const CostCenters: React.FC<ICostCentersProps> = ({ title }) => {
  window.document.title = title;

  const { listAllCostCenters } = useCostCenterService();
  ...
  const [orderField, setOrderField] = useState<string>("classification");
  ...
  const handleToCostCenter = useCallback(
    (id: string | null) => {
      !!id ? navigate(`/cost-center/${id}`) : navigate("/cost-center");
    },
    [navigate]
  );
                  ...
                  return (
                    ...
                    >
                      <CustomMenuItem
                        ...
                        handleToEdit={handleToCostCenter}
                        disableButton={true}
                      />
                      ...
                      <CustomTableCell
                        size="small"
                        title={costCenter.classification}
                        width={200}
                      >
