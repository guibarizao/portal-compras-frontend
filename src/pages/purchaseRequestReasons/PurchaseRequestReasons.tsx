...
interface IPurchaseRequestReasonsProps {
  title: string;
}
...
const PurchaseRequestReasons: React.FC<IPurchaseRequestReasonsProps> = ({
  title,
}) => {
  ...
  const handleToPurchaseRequestReasons = useCallback(
    (id: string | null) => {
      !!id
        ? navigate(`/purchase-request-reason/${id}`)
        : navigate("/purchase-request-reason");
    },
    [navigate]
  );
  ...
  return (
    <>
      <TitleContainer>
        <h1>Montivo de solicitação de compra</h1>
      </TitleContainer>
      <PageCard>
        <FilterButtonGroup>
          ...
          <Tooltip title="Adicionar motivo" placement="top">
            <IconButton
              onClick={() => handleToPurchaseRequestReasons(null)}
              size="small"
              color="primary"
              style={{ alignItems: "flex-end" }}
            >
        ...
        >
          ...
          >
            ...
            <TableBody>
              {purchaseRequestReasons.length > 0 &&
                purchaseRequestReasons.map((purchaseRequestReason) => {
                  return (
                    <TableRow
                    ...
                    >
                      <CustomMenuItem
                        ...
                        handleToEdit={handleToPurchaseRequestReasons}
                      />
                      ...
                      <TableCell
                        size="small"
                        width={200}
                        title={purchaseRequestReason.description}
                      >
          ...
          {purchaseRequestReasons.length === 0 && (
            <CustomNoContentTableBody>
              <p>Nenhum tipo de solicitação de compra encontrada</p>
            </CustomNoContentTableBody>
          )}
        </TableContainer>
...
export default PurchaseRequestReasons;
